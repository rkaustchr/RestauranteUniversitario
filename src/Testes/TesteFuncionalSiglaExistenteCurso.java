...
public class TesteFuncionalSiglaExistenteCurso extends DBTestCase {
...
private FlatXmlDataSet bancoCarregado;
	...
	public void testCriarCurso() throws SQLException, Exception
	{
		...
		RoteiroCriarCurso rCriarCurso2 = new RoteiroCriarCurso("Historia", "CC", "DCC");
		rCriarCurso2.executar();
		
	
		IDataSet dadosSetBanco = getConnection().createDataSet();
		ITable dadosNoBanco = dadosSetBanco.getTable("curso");
		
		IDataSet dadosSetEsperado = new FlatXmlDataSetBuilder().build(new FileInputStream("xml/datasetSiglaCurso.xml"));
	...
	protected IDataSet getDataSet() throws Exception {
		bancoCarregado = new FlatXmlDataSetBuilder().build( new FileInputStream("xml/datasetSiglaCurso.xml"));
