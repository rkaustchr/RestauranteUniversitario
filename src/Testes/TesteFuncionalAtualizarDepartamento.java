...
public class TesteFuncionalAtualizarDepartamento extends DBTestCase{
	...
	public void testAtualizarDepartamento() throws SQLException, Exception
	{
		...
		RoteiroAtualizarDepartamento rAtualizarDepartamento = new RoteiroAtualizarDepartamento("DCC", "Departamento de Historia");
		...
		IDataSet dadosSetEsperado = new FlatXmlDataSetBuilder().build(new FileInputStream("xml/datasetAtualizarDepartamento.xml"));
	...
	protected IDataSet getDataSet() throws Exception {
		bancoCarregado = new FlatXmlDataSetBuilder().build( new FileInputStream("xml/datasetAtualizarDepartamento.xml"));
